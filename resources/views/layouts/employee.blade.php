...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/logo-andelin.png') }}" type="image/png">
    ...
    <div class="main-content">
        <div class="topbar mb-4 rounded-4">
            <div class="topbar-start">
                <button class="btn sidebar-toggle d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#employeeSidebar" aria-controls="employeeSidebar">
                    <i class="fas fa-bars"></i>
                </button>
                <div class="topbar-heading">
                    <span class="topbar-kicker">Panel Karyawan</span>
                    <h1 class="topbar-title">@yield('page-title', 'Beranda')</h1>
                    <p class="topbar-subtitle">Pantau tugas, jadwal, dan pengajuan Anda dengan tampilan yang lebih ringkas.</p>
                </div>
            </div>
            <div class="topbar-actions">
                <span class="user-chip">
                    <span class="user-chip-avatar"><i class="fas fa-user"></i></span>
                    <span class="user-chip-meta">
                        <span class="user-chip-name">{{ auth()->user()->name }}</span>
                        <span class="user-chip-role">Karyawan</span>
                    </span>
                </span>
